                    ...
                    def crear_imagen_cumple(template_url, foto_url, nombre, fecha):
                        try:
                            ...
                            try:
                                ...
                                img_foto = Image.new('RGBA', (200, 200), (255, 255, 255, 0))
                            
                            # 3. Recortar foto en círculo
                            size = (180, 180) # Tamaño del círculo
                            ...
                            # 4. Pegar foto circular en la plantilla (Ajustar estas coordenadas: 120, 500)
                            img_base.paste(img_circular, (120, 500), img_circular) 
                            ...
                            # 6. Coordenadas para el texto (Ajustar estas también)
                            draw.text((150, 300), nombre, font=fuente_nombre, fill=(255, 255, 255)) 
                            draw.text((250, 350), fecha, font=fuente_fecha, fill=(255, 215, 0)) 
                            ...
                            if imagen_bytes:
                                ...
                                with col_b2:
                                    ...
                                    if wa_num and wa_num != "nan":
                                        wa_url = f"https://wa.me/51{wa_num}?text=¡Feliz%20Cumpleaños,%20{row['Trabajador']}!%20🥳"
