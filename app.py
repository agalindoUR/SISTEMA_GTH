...
# ==========================================
    ...
    # ==========================================
        ...
        if df_evals.empty:
            ...
            # Función para convertir el texto "Comp1:4 | Comp2:5" a un diccionario de Python
            ...
            # CREAMOS LAS 4 PESTAÑAS AL ESTILO POWER BI
            ...
            with tab1:
                ...
                if not notas_gen:
                    ...
                    for comp, nota in notas_gen.items():
                        # Usamos st.progress para hacer una barra visual. Asumimos nota max de 5.
                        porcentaje = int((nota / 5.0) * 100)
                        st.write(f"**{comp}** - Nota: {nota}/5")
                        st.progress(porcentaje)
                        
            # --- PESTAÑA 2: ESPECÍFICAS ---
            with tab2:
            ...
            with tab4:
                ...
                prom_total = datos_emp.get("promedio", 0)
                ...
                # Matriz simple de talento (ejemplo básico)
