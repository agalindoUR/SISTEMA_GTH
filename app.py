                ...
                if not df_cumple.empty:
                    ...
                    for _, row in df_cumple.iterrows():
                        ...
                        with st.expander(f"🎉 {row['Trabajador']} ({row['Fecha de cumpleaños']})"):
                            html_ind = f"""<div style="position: relative; width: 100%; max-width: 500px; margin: auto; overflow: hidden; border-radius: 15px; box-shadow: 0px 4px 10px rgba(0,0,0,0.2);">
