                ...
                for i, tab in enumerate(tabs):
                    ...
                    with tab:
                        ...
                        # ==========================================
                            ...
                            # Le pasas las variables que la función necesita para operar
                            # Asumo que col_conf y exportar_df_a_sheets ya están definidas previamente en este archivo
                            col_conf_exp = col_conf if 'col_conf' in locals() else {}
                            renderizar_experiencia_laboral(dni_buscado, dfs, exportar_df_a_sheets, col_conf_exp)
